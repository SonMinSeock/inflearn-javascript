...
const isFruit = console.log(fruits.includes('망고'));

const findFruitIdx = fruits.findIndex((fruit) => fruit === '포도');
console.log(findFruitIdx);

const filteredFruits = fruits.filter((fruit) => fruit === '사과');
